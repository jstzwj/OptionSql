#ifndef OPTIONSQL_PLATFORM_H_
#define OPTIONSQL_PLATFORM_H_
...
#	if defined(OPTIONSQL_BUILD_DLL_EXPORT)
#		define OPTIONSQL_EXPORT __declspec(dllexport)
#		define OPTIONSQL_EXPORT_WINONLY __declspec(dllexport)
#	else
#		define OPTIONSQL_EXPORT __declspec(dllimport)
#		define OPTIONSQL_EXPORT_WINONLY __declspec(dllimport)
#	endif

#	define OPTIONSQL_CALL __stdcall
#	define OPTIONSQL_INLINE __forceinline
#	define OPTIONSQL_WONT_RETURN __declspec(noreturn)
#else
#	define OPTIONSQL_EXPORT __attribute__ ((visibility("default")))
#	define OPTIONSQL_EXPORT_WINONLY
#
#	define OPTIONSQL_CALL
#	define OPTIONSQL_INLINE inline
#	define OPTIONSQL_WONT_RETURN
#endif
